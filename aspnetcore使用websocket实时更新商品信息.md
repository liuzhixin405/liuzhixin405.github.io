...
**发布日期:** 2024-01-05  
**原文链接:** https://www.cnblogs.com/morec/p/17947739  
**标签:** 无
...
![](./images/aspnetcore使用websocket实时更新商品信息/image_1.gif)

![](./images/aspnetcore使用websocket实时更新商品信息/image_2.gif)

中间几次调用过程省略。。。

暂时只用到了下面四个项目

![](./images/aspnetcore使用websocket实时更新商品信息/image_3.png)
