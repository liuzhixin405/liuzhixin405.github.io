...
**发布日期:** 2023-02-18  
**原文链接:** https://www.cnblogs.com/morec/p/17131840.html  
**标签:** 无
...
![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_1.jpg)
...
![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_2.jpg)

aspnetcore发布代码掠过，下面是发布后的代码，我直接拷贝到我的虚拟机home目录下面。

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_3.jpg)
...
![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_5.jpg)

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_6.jpg)
...
![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_7.jpg)

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_8.jpg)

官方文档介绍的不是很多，而且我也只是近期才研究这个，所以这个问题如果有能解答的万分感谢！

配置文件appsettings.json需要指定端口，否则两个以上服务部署会默认5000冲突。

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_9.jpg)
...
w![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_10.jpg)

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_11.jpg)

![](./images/心酸部署dapr经历，最后一步莫名的遗憾/image_12.jpg)

 源代码：

[exercisebook/Dapr/DaprDemo at main · liuzhixin405/exercisebook (github.com)](https://github.com/liuzhixin405/exercisebook/tree/main/Dapr/DaprDemo)
