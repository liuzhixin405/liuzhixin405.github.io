...
![](images/Typora使用教程/image_2.gif)

2.强调 在要强调内容前后分别加两个“*”号。
![](images/Typora使用教程/image_3.gif)

3.斜体 前后分别加一个“*”号。
![](images/Typora使用教程/image_4.gif)

4.删除线 内容前后分别加上两个“~”号。
![](images/Typora使用教程/image_5.gif)

# list列表处理

1.有序列表 输入数字“1”+“.”+空格 ， 自动开始有序列表。
![](images/Typora使用教程/image_6.gif)

2.无序列表 输入“+”或“-”或“*”+空格，自动开始无序列表。
![](images/Typora使用教程/image_7.gif)

3.table表格 Ctrl+T,在弹出的对话框中选择行列数，自动生成列表。 还可以很方便地对表格进行编辑。
![](images/Typora使用教程/image_8.gif)

当然还有另外一种建立表格的方式用'|'分隔然后回车创建表格,使用ctrl+回车新添一行
![](images/Typora使用教程/image_9.gif)

4.分割线 输入三个或三个以上“-”（“*”），再按回车键，即出现一条分割线。
![](images/Typora使用教程/image_10.gif)

5.插入 插入本地图片：直接把图片拖入即可； 插入网络图片：![图片标题]（图片链接）。
![](images/Typora使用教程/image_11.gif)

6.链接 [链接提示]+(链接地址)。
![](images/Typora使用教程/image_12.gif)

7.数学公式 “$$”+回车。
![](images/Typora使用教程/image_13.gif)

8.代码 行内代码：代码的两端各加一个“`”号，（在Tab键上面，英文输入法）。 代码块：输入三个“~”，按回车键，即可选择编程语言。
![](images/Typora使用教程/image_14.gif)

![](images/Typora使用教程/image_15.gif)
