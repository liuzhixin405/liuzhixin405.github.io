...
**发布日期:** 2023-10-22  
**原文链接:** https://www.cnblogs.com/morec/p/17779841.html  
**标签:** 无
...
![](images/aspnetcore微服务之间grpc通信,无proto文件/image_1.png)

Server里面包含简单jwt的token的生成，client和002需要调用登录，通过外部接口调用传入用户和密码，内部再调用jwt服务。

![](images/aspnetcore微服务之间grpc通信,无proto文件/image_2.png)

![](images/aspnetcore微服务之间grpc通信,无proto文件/image_3.png)

![](images/aspnetcore微服务之间grpc通信,无proto文件/image_4.png)
