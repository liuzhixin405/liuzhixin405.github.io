...
**发布日期:** 2023-02-20  
**原文链接:** https://www.cnblogs.com/morec/p/17139390.html  
**标签:** 无
...
![](./images/windows下dapr的代码调试--非docker部署/image_2.jpg)
...
![](./images/windows下dapr的代码调试--非docker部署/image_3.jpg)

安装完后可以看到在本机的用户账号下生成的目录，打开components文件夹，会看到statestore.yaml文件，是不是有点熟悉，这就是状态管理和发布订阅默认的存储容器redis配置。

![](./images/windows下dapr的代码调试--非docker部署/image_4.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_5.jpg)
...
![](./images/windows下dapr的代码调试--非docker部署/image_6.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_7.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_8.jpg)
...
![](./images/windows下dapr的代码调试--非docker部署/image_9.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_10.jpg)

下面就是附加进程了，首先把代码打好断点，再把这两个进程加入到vs中，一下子不能同时添加两个进程，加完Server再加Client,没有先后顺序。

![](./images/windows下dapr的代码调试--非docker部署/image_11.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_12.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_13.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_14.jpg)

下面就来调试代码了，输入client请求的接口地址,client写了日志，server没有写，所以控制台只打印client输出的信息：

![](./images/windows下dapr的代码调试--非docker部署/image_15.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_16.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_17.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_18.jpg)

![](./images/windows下dapr的代码调试--非docker部署/image_19.jpg)
