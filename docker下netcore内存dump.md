...
**发布日期:** 2023-03-01  
**原文链接:** https://www.cnblogs.com/morec/p/17166092.html  
**标签:** 无
...
![](./images/docker下netcore内存dump/image_1.jpg)
...
![](./images/docker下netcore内存dump/image_2.jpg)
...
![](./images/docker下netcore内存dump/image_3.jpg)

遇到这个Operation not permitted命令我要回头重启一下服务带上--privileged=true了，因为我中途干了别的。

![](./images/docker下netcore内存dump/image_4.jpg)

如果想查看一下内部的pid,可以通过top命令，下面是安装top的。。。

![](./images/docker下netcore内存dump/image_5.jpg)

![](./images/docker下netcore内存dump/image_6.jpg)
...
![](./images/docker下netcore内存dump/image_7.jpg)
...
[使用 dotnet-monitor 分析.NET 应用程序 - SpringLeee - 博客园 (cnblogs.com)](https://www.cnblogs.com/myshowtime/p/14214728.html)
 ...
 ![](./images/docker下netcore内存dump/image_8.jpg)
