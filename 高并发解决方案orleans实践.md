...
**发布日期:** 2023-01-10  
**原文链接:** https://www.cnblogs.com/morec/p/17038959.html  
**标签:** 无

---

![](./images/高并发解决方案orleans实践/image_1.png)
开具一张图，展开来聊天。有从单个服务、consul集群和orleans来展开高并发测试一个小小数据库并发实例。

首先介绍下场景，创建一个order，同时去product表里面减掉一个库存。很简单的业务但是遇到并发问题在项目中就很头痛。

![](./images/高并发解决方案orleans实践/image_2.png)

![](./images/高并发解决方案orleans实践/image_3.png)
...
![](./images/高并发解决方案orleans实践/image_4.png)

高并发测试工具我用的是postjson_windows，自行百度。很方便。

![](./images/高并发解决方案orleans实践/image_5.png)
...
![](./images/高并发解决方案orleans实践/image_6.png)

![](./images/高并发解决方案orleans实践/image_7.png)

![](./images/高并发解决方案orleans实践/image_8.png)
...
![](./images/高并发解决方案orleans实践/image_9.png)
...
![](./images/高并发解决方案orleans实践/image_11.png)

下面只要启动了网关就会链接上服务，这里需要启动先后顺序，先服务后网关要不然网关会起不来。启动后服务掉线或者关掉都不会再影响网关，自动注册和发现。

![](./images/高并发解决方案orleans实践/image_12.png)

通过swagger试了一条数据，服务正常，服务被服务端口5008,网关端口30002的执行了。

![](./images/高并发解决方案orleans实践/image_13.png)

并发测试结果，看sql注释有提前把库存还原，order清空：

![](./images/高并发解决方案orleans实践/image_14.png)

![](./images/高并发解决方案orleans实践/image_15.png)

![](./images/高并发解决方案orleans实践/image_16.png)

看看是哪些服务拿到了请求，因为500次请求只有100个库存所以后面就是一直库存不足，而且每个服务都参与了处理。

![](./images/高并发解决方案orleans实践/image_17.png)
...
![](./images/高并发解决方案orleans实践/image_18.png)
