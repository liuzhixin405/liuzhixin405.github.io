...
**发布日期:** 2023-03-22  
**原文链接:** https://www.cnblogs.com/morec/p/17242170.html  
**标签:** 无
...
![](images/aspnetcore微服务中使用发件箱模式实例/image_1.png)
...
![](images/aspnetcore微服务中使用发件箱模式实例/image_2.png)

![](images/aspnetcore微服务中使用发件箱模式实例/image_3.png)

![](images/aspnetcore微服务中使用发件箱模式实例/image_4.png)

![](images/aspnetcore微服务中使用发件箱模式实例/image_5.png)

这里出现了一个喜闻乐见的事情,trading服务已经发布了事件，billing服务没收到，可能是rabbitmq卡住了，不过没关系，因为有这个发件箱模式可以重启下服务，这个时间丢不了。

重启了下服务就消费掉了这条数据。

![](images/aspnetcore微服务中使用发件箱模式实例/image_6.png)
